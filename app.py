...
user_input = st.text_input("Your line:", placeholder="E.g., 'I'm the king of code, don't test my flow.'")
style = st.selectbox("Rap Style", ["Freestyle", "Old School", "Trap", "Shakespearean 😅"])
